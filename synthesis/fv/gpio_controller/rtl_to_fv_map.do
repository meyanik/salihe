...
# Generated on: Thu Jul 11 01:02:00 CEST 2024 (Wed Jul 10 23:02:00 UTC 2024)
...
set logfile fv/gpio_controller/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/gpio_controller -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/apps/GENUS211/21.18.000/tools"
set CDN_SYNTH_ROOT      "/apps/GENUS211/21.18.000/tools"
set env(CW_DIR) "/apps/GENUS211/21.18.000/tools/lib/chipware"
set CW_DIR      "/apps/GENUS211/21.18.000/tools/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /apps/GENUS211/21.18.000/tools/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/apps/GENUS211/21.18.000/tools/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/apps/GENUS211/21.18.000/tools/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/apps/GENUS211/21.18.000/tools/lib/chipware/sim"
    set CW_DIR_SIM      "/apps/GENUS211/21.18.000/tools/lib/chipware/sim"
}
...
read_library -liberty -both \
    /home/myanik/work/teknofest24/alaz/playground/gpio/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/gpio.v
elaborate_design -golden -root {gpio_controller} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/gpio_controller/fv_map.v.gz
elaborate_design -revised -root {gpio_controller}
...
#add_name_alias fv/gpio_controller/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.gpio_controller.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.gpio_controller.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.gpio_controller.rtl.fv_map.rpt
